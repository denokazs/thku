        ...
        >
            ...
            <div className="w-full pt-20 px-16 flex items-center justify-between relative z-20 mt-8">
                <div className="flex items-center gap-6">
                    <div className="w-[120px] h-[120px] rounded-full ring-2 ring-white/20 bg-white shadow-[0_0_40px_rgba(255,255,255,0.15)] overflow-hidden flex items-center justify-center p-2">
                        <img
                            src={LOGO_BASE64}
                            alt="THK Logo"
